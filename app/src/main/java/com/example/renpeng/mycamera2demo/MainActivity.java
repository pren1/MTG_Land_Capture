package com.example.renpeng.mycamera2demo;
...
public class MainActivity extends Activity
    ...
    private void requestCameraPermission() {
        if (shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
            ...
            Log.e("MyCV","Question about permission?");
        } else {
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // 这里的size是1280，720. 并且换成1920和1080后会报错。
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            // 这个例程就只有这一部分有 createCaptureSession
            // 虽然mImageReader.getSurface()在别的地方也用了：captureStillPicture
    ...
    private int getOrientation(int rotation) {
        ...
        Log.e("MyCV","The orientation should be:"+mSensorOrientation);
    ...
    private void setAutoFlash(CaptureRequest.Builder requestBuilder) {
        if (mFlashSupported) {
            // CONTROL_AE_MODE 就只有这里用了,设置flash
            // Like ON, except that the camera device also controls the camera's flash unit,
